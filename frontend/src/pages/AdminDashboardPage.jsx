...
const StatCard = ({ icon, title, value, color }) => (
    <div
        className={`bg-white shadow rounded-lg p-6 flex items-center ${color}`}
    >
            ...
            <div className="px-4 py-6 sm:px-0">
                ...
                <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <StatCard
                        ...
                        value={total_analysis_results}
                        color="text-purple-500"
                    />
                    <StatCard
                        icon={<FaTasks />}
                        title="Processing"
                        value={uploads_by_status.processing || 0}
                    />
                    <StatCard
                        icon={<FaCheckCircle />}
                        title="Completed"
                        value={uploads_by_status.completed || 0}
                        color="text-green-500"
                    />
                    <StatCard
                        icon={<FaTimesCircle />}
                        title="Failed"
                        value={uploads_by_status.failed || 0}
                        color="text-red-500"
                    />
                </div>
